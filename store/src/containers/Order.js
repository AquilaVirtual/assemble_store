    ...
    render() {
        return (
            ...
            <div className="form-group">
              ...
              <input type="text" className="form-control" id="inputAddress" placeholder="Name on Card" />
            </div>
            <div className="form-group">
              <label for="inputAddress2">Card Number</label>
              <input type="text" className="form-control" id="inputAddress2" placeholder="XXXX XXXX XXXX XXXX" />
            </div>                
            <div className="form-group">
            <form method="post">
            ...
            <div className="form-group">
              ...
              <input type="text" className="form-control" id="inputAddress2" placeholder="CVV" />
            </div>                
          </form>
          </div>
          <div className="col-6">
